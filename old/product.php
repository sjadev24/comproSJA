...
<center><u><div class="p-title"><h3 style="font-family: Neoland; color:white; user-select: none; pointer-events: none;"><?php echo $p_name; ?></h3></div></u></center>
<div class="page">
	<div class="container">
		<div class="row">
			<!--<div class="col-md-12">
				...
				<div class="product">
					<div class="row">
						...
						<div class="col-md-7"><br><br><br><br>
							<div class="p-title"><h3 style="font-family: Neoland; color:white; user-select: none; pointer-events: none;"><?php echo $p_name; ?></h3></div>
							<div class="p-review">
								<div class="rating">
                                    <?php
                                    if($avg_rating == 0) {
							...
							<div class="p-short-des" style="color:white; user-select: none; pointer-events: none;">
								<p>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="#feature" aria-controls="feature" role="tab" data-toggle="tab">
								    <?php /* echo LANG_VALUE_60; */?>
								    Interior
								</a></li>
                                <li role="presentation"><a href="#return_policy" aria-controls="return_policy" role="tab" data-toggle="tab">
							...
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane active" id="description" style="margin-top: -30px; color:white; user-select: none; pointer-events: none;">
									<p>
                                        <?php
                                        if($p_description == '') {
                                            echo LANG_VALUE_70;
                                ...
                                <div role="tabpanel" class="tab-pane" id="feature" style="margin-top: -30px; color:white; user-select: none; pointer-events: none;">
                                    <p>
                                        <?php
                                        if($p_feature == '') {
                                            echo LANG_VALUE_71;
                                ...
                                <div role="tabpanel" class="tab-pane" id="condition" style="margin-top: -30px; color:white; user-select: none; pointer-events: none;">
                                    <p>
                                        <?php
                                        if($p_condition == '') {
                                            echo LANG_VALUE_72;
                                ...
                                <div role="tabpanel" class="tab-pane" id="return_policy" style="margin-top: -30px; color:white; user-select: none; pointer-events: none;">
                                    <p>
                                        <?php
                                        if($p_return_policy == '') {
                                            echo LANG_VALUE_73;
								...
								<div role="tabpanel" class="tab-pane" id="review" style="margin-top: -30px; color:white; user-select: none; pointer-events: none;">
...
<!--<div class="product bg-white pt_70 pb_70">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
