    ...
    @font-face /*perintah untuk memanggil font eksternal*/
        {
            ...
            src: url('../sja/assets/fonts/neoland_serif/Neoland Serif.ttf');/*memanggil file font eksternalnya di folder nexa*/
        }
</style>
...
<!-- top bar -->
<div class="top" style="background: url(bordesmaroon.jpg) no-repeat center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
	<div class="container">
		<div class="row">
...
<div class="header" style="background-color:black;">
	<div class="container">
		<div class="row inner">
			<div class="col-md-4 logo"><!-- LOGO -->
				<a href="index.php"><img src="assets/uploads/<?php echo $logo; ?>" alt="logo image" style="width:450px; height:70px;"></a>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 pl_0 pr_0">
				<div class="menu-container" style="font-family: Neoland;">
					<div class="menu" style="background-color: black;">
						<ul>
							...
							<li><a href="galeri.php"><?php echo Gallery ?></a></li>
