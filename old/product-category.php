                                ...
                                foreach ($result as $row) {
                                    ...
                                    <div class="col-md-4 item item-product-cat">
                                        <div class="inner">
                                            ...
                                            <div class="text" style="background: url(bordesmaroon.jpg);filter: grayscale(1);">
                                                <h3 style="background-color:white;"><a href="product.php?id=<?php echo $row['p_id']; ?>"><b><?php echo $row['p_name']; ?></b></a></h3>
                                                <!--<h4>
