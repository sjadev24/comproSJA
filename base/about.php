      ...
      <div class="col-md-10">
        <div class="row">
          ...
          <div class="col-md-7">
            ...
            <p class="mb-5">Since the beginning, the aspiration of PT. Senang Jaya Abadi
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 gy-4">
          ...
          <div class="col">
            <div class="text-center my-2">
              ...
              <h4 class="h5 mb-3">Customer Focus</h4>
          ...
          <div class="col">
            <div class="text-center my-2">
              ...
              <h4 class="h5 mb-3">Sustainability</h4>
            ...
            <ul class="steps">
              <li class="step">
                ...
                <div class="d-flex flex-column pt-1">
                  <h4 class="h5">Design and Engineering</h4>
                  <p class="mb-0">
              ...
              <li class="step">
                ...
                <div class="d-flex flex-column pt-1">
                  <h4 class="h5">After-sales Support</h4>
                  <p class="mb-0">
...
<section class="section section-aboutcta">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h2 class="mb-4">Connect with our experts</h2>
        <p class="mb-6">Have questions about our services or need personalized advice? Reach out today and let us help you find the perfect solution for your needs!</p>
