                ...
                <div class="row contact-info">
                    ...
                    <div class="col-md-6 col-lg-5">
                        ...
                        <ul class="d-flex flex-column gap-3">
                            ...
                            <li>
                                <a class="text-primary" href="https://api.whatsapp.com/send?phone=+6285691412627&text=Hi...Dengan Karoseri Senang Jaya Abadi...?" target="_blank" rel="noopener">
                                    Marketing 2
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="text-primary" href="https://api.whatsapp.com/send?phone=+6281265533700&text=Hi...Dengan Karoseri Senang Jaya Abadi...?" target=" _blank" rel="noopener">
                                    Marketing 5
                                </a>
                            </li>
                        </ul>
